...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NAVI] = LAYOUT(
    ...
    _______, _______, _______, EMACS,   _______, _______,                KC_GRV,  KC_9,    KC_0,    _______, _______,    _______,  _______, _______, _______,
    _______, _______, _______, _______, _______, TELE,      KC_CAPS,     KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______,    _______,  _______, _______,
  ...
  [SYS] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______,    _______,  _______, _______,
    _______, _______, _______, _______, _______, _______,                KC_3,    KC_LBRC, KC_RBRC, _______, _______,    _______,  _______, _______, _______,
