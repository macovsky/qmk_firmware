...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NAVI] = LAYOUT(
    ...
    _______, _______, _______, EMACS,   _______, TERM,                   KC_GRV,  KC_LBRC, KC_RBRC, _______, _______,    _______,  _______, _______, _______,
    _______, _______, _______, DISC,    _______, TELE,      KC_DEL,      KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______,    _______,  _______, _______,
