...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
    ...
    SFT_EN,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     _______,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,    RU,            _______,
  ...
  [NAVI] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                KC_GRV,  KC_LBRC, KC_RBRC, KC_BSLS, KC_PSCR,    _______,  _______, _______, _______,
    ...
    _______, _______, _______,          _______,       _______, TERM, BROWSER,      _______,          _______,    _______,  _______, _______, _______),
  [SYS] = LAYOUT(
