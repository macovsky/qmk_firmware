...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_60_ansi(
	       ...
	       CTL_CAPS,KC_LALT, KC_LGUI,          KC_SPC,                                      FN,      KC_RGUI, COMPOSE, SFT_CAPS),

  [1] = LAYOUT_60_ansi(
	       KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,   KC_F12,  KC_DEL, \
	       _______, _______, KC_MS_U, _______, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,    _______, KC_INS, \
	       _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,KC_LEFT, KC_RIGHT,          KC_BTN2,\
